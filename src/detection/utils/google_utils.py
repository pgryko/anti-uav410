...
def attempt_download(weights):
    ...
    if file in models and not os.path.isfile(weights):
        # Google Drive (public model IDs, not secrets)
        # d = {'yolov5s.pt': '1R5T6rIyy3lLwgFXNms8whc-387H0tMQO',  # pragma: allowlist secret
        #      'yolov5m.pt': '1vobuEExpWQVpXExsJ2w-Mbf3HJjWkQJr',  # pragma: allowlist secret
        #      'yolov5l.pt': '1hrlqD1Wdei7UT4OgT785BEk1JwnSvNEV',  # pragma: allowlist secret
        #      'yolov5x.pt': '1mM8aZJlWTxOg7BZJvNUMrTnA2AbeCVzS'}  # pragma: allowlist secret
...
def gdrive_download(
    id="1n_oKgR81BJtqk75b00eAjdv03qVCQn2f",  # pragma: allowlist secret
    name="coco128.zip",
):
