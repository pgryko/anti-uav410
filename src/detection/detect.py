...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights", nargs="+", type=str, default=r".\best_drone.pt", help="model.pt path(s)"
    )
    parser.add_argument(
        "--source", type=str, default=r".\drone_data\images\val", help="source"
    ...
    parser.add_argument(
        "--save-dir", type=str, default="./runs/detect", help="directory to save results"
    )
    parser.add_argument(
