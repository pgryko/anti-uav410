...
Default_Trackers = [
    ...
    {
        "name": "Unicorn-Large",
        "path": "./Tracking_results/Defaults/Unicorn_sot/unicorn_track_large",
        "mode": 1,
    },
    {
        "name": "Unicorn-Tiny",
        "path": "./Tracking_results/Defaults/Unicorn_sot/unicorn_track_tiny",
        "mode": 1,
    },
    {"name": "AiATrack", "path": "./Tracking_results/Defaults/AiATrack/baseline", "mode": 1},
    {
        "name": "OSTrack-256",
        "path": "./Tracking_results/Defaults/OSTrack/vitb_256_mae_ce_32x4_ep300",
        "mode": 1,
    },
    {
        "name": "OSTrack-384",
        "path": "./Tracking_results/Defaults/OSTrack/vitb_384_mae_ce_32x4_ep300",
        "mode": 1,
    },
    ...
    {
        "name": "SeqTrack-B256",
        "path": "./Tracking_results/Defaults/SeqTrack/seqtrack_b256",
        "mode": 1,
    },
    {
        "name": "SeqTrack-B384",
        "path": "./Tracking_results/Defaults/SeqTrack/seqtrack_b384",
        "mode": 1,
    },
    {
        "name": "ARTrack",
        "path": "./Tracking_results/Defaults/ARTrack/artrack_seq_256_full",
        "mode": 1,
    },
    {
        "name": "DropTrack",
        "path": "./Tracking_results/Defaults/DropTrack/ostrack/vitb_384_mae_ce_32x4_got10k_ep100",
        "mode": 1,
    },
    {"name": "GRM", "path": "./Tracking_results/Defaults/GRM/vitb_256_ep300", "mode": 1},
    {
        "name": "MixformerV2-B",
        "path": "./Tracking_results/Defaults/MixformerV2/mixformer2_vit_online/288_depth8_score",
        "mode": 1,
    },
...
Trained_Trackers = [
    ...
    {
        "name": "AiATrack",
        "path": "./Tracking_results/Trained_with_antiuav410/AiATrack/baseline",
        "mode": 1,
    },
    ...
    {
        "name": "PrDiMP50",
        "path": "./Tracking_results/Trained_with_antiuav410/DiMP/prdimp50",
        "mode": 1,
    },
    {
        "name": "Super_DiMP",
        "path": "./Tracking_results/Trained_with_antiuav410/DiMP/super_dimp",
        "mode": 1,
    },
    {
        "name": "GlobalTrack",
        "path": "./Tracking_results/Trained_with_antiuav410/GlobalTrack",
        "mode": 2,
    },
    {
        "name": "KeepTrack",
        "path": "./Tracking_results/Trained_with_antiuav410/KeepTrack",
        "mode": 1,
    },
    ...
    {
        "name": "Stark-ST101",
        "path": "./Tracking_results/Trained_with_antiuav410/Stark-ST101",
        "mode": 1,
    },
    {
        "name": "SwinTrack-Tiny",
        "path": "./Tracking_results/Trained_with_antiuav410/SwinTrack-Tiny",
        "mode": 2,
    },
    {
        "name": "SwinTrack-Base",
        "path": "./Tracking_results/Trained_with_antiuav410/SwinTrack-Base",
        "mode": 2,
    },
    ...
    {
        "name": "ToMP101",
        "path": "./Tracking_results/Trained_with_antiuav410/ToMP/tomp101",
        "mode": 1,
    },
    {
        "name": "DropTrack",
        "path": "./Tracking_results/Trained_with_antiuav410/DropTrack/ostrack/vitb_384_mae_ce_32x4_got10k_ep100",
        "mode": 1,
    },
    {
        "name": "MixformerV2-B",
        "path": "./Tracking_results/Trained_with_antiuav410/MixFormerV2/mixformer2_vit_online/288_depth8_score",
        "mode": 1,
    },
]
