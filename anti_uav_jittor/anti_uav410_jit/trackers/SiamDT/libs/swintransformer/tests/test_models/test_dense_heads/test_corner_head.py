...
def test_corner_head_loss():
    ...
    gt_bboxes = [
        torch.Tensor(
            [[23.6667, 23.8757, 238.6326, 151.8874], [123.6667, 123.8757, 138.6326, 251.8874]]
        ),
    ]
    ...
    for tl_emb_feat, br_emb_feat in zip(tl_embs, br_embs, strict=False):
...
def test_corner_head_encode_and_decode_heatmap():
    ...
    s = 256
    img_metas = [
        {"img_shape": (s, s, 3), "scale_factor": 1, "pad_shape": (s, s, 3), "border": (0, 0, 0, 0)}
    ]
