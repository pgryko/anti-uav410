...
class GuidedAnchorHead(AnchorHead):
    ...
    def ga_shape_targets(
        ...
        (all_bbox_anchors, all_bbox_gts, all_bbox_weights, pos_inds_list, neg_inds_list) = (
            multi_apply(
    ...
    def loss(
        ...
        if shape_targets is None:
            return None
        (bbox_anchors_list, bbox_gts_list, anchor_weights_list, anchor_fg_num, anchor_bg_num) = (
            shape_targets
        )
    ...
    def _get_bboxes_single(
        ...
        for cls_score, bbox_pred, anchors, mask in zip(
            cls_scores, bbox_preds, mlvl_anchors, mlvl_masks, strict=False
        ):
