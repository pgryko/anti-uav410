...
from mmdet.core import bbox2distance, bbox_overlaps, distance2bbox, multi_apply, reduce_mean
...
class LDHead(GFLHead):
    ...
    def loss(
        ...
        return dict(
            loss_cls=losses_cls, loss_bbox=losses_bbox, loss_dfl=losses_dfl, loss_ld=losses_ld
        )
