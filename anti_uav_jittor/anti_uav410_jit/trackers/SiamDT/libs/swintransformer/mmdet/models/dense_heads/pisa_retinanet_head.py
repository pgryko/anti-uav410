...
class PISARetinaHead(RetinaHead):
    ...
    def loss(self, cls_scores, bbox_preds, gt_bboxes, gt_labels, img_metas, gt_bboxes_ignore=None):
        ...
        if isr_cfg is not None:
            ...
            (flatten_labels, flatten_label_weights, flatten_bbox_targets, flatten_bbox_weights) = (
                all_targets
            )
        ...
        losses_cls = self.loss_cls(
            flatten_cls_scores, flatten_labels, flatten_label_weights, avg_factor=num_total_samples
        )
