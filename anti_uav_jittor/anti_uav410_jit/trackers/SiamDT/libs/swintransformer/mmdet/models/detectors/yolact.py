...
class YOLACT(SingleStageDetector):
    ...
    def forward_train(
        ...
        for loss_name in losses.keys():
            ...
            ), f"{loss_name} becomes infinite or NaN!"
    ...
    def simple_test(self, img, img_metas, rescale=False):
        ...
        bbox_results = [
            ...
            for det_bbox, det_label in zip(det_bboxes, det_labels, strict=False)
        ]
        ...
        return list(zip(bbox_results, segm_results, strict=False))
