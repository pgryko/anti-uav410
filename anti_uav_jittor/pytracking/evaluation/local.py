...
def local_env_settings():
    ...
    settings.got_packed_results_path = (
        "/home/cx/TransT/pytracking/tracking_results/got_packed_results/"
    )
    settings.got_reports_path = ""
    settings.lasot_path = "/home/cx/cx3/LaSOTBenchmark"
    settings.network_path = (
        "/home/cx/detr-tracking/pytracking/networks/"  # Where tracking networks are stored.
    )
    ...
    settings.results_path = (
        "/home/cx/TransT/pytracking/tracking_results"  # Where to store tracking results
    )
