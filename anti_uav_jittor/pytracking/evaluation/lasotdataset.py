...
class LaSOTDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        occlusion_label_path = f"{self.base_path}/{class_name}/{sequence_name}/full_occlusion.txt"
        ...
        out_of_view_label_path = f"{self.base_path}/{class_name}/{sequence_name}/out_of_view.txt"
        out_of_view = load_text(
            str(out_of_view_label_path), delimiter=",", dtype=np.float64, backend="numpy"
        )
        ...
        frames_list = [
            f"{frames_path}/{frame_number:08d}.jpg"
