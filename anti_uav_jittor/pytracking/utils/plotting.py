...
def show_tensor(a: jt.Var, fig_num=None, title=None, range=(None, None), ax=None):
    """Display a 2D tensor.
    args:
...
def plot_graph(a: jt.Var, fig_num=None, title=None):
...
def show_image_with_boxes(im, boxes, iou_pred=None, disp_ids=None):
    ...
    im_tensor = jt.array(im_np.transpose(2, 0, 1)).float()
