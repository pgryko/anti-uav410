...
def run_experiment(experiment_module: str, experiment_name: str, debug=0, threads=0):
    ...
    """
    expr_module = importlib.import_module(f"pytracking.experiments.{experiment_module}")
...
def main():
    ...
    parser.add_argument(
        "experiment_module", type=str, help="Name of experiment module in the experiments/ folder."
    )
