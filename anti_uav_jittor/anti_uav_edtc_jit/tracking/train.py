...
def parse_args():
    ...
    parser.add_argument(
        "--stage1_model", type=str, default=None, help="stage1 model used to train SPM."
    )
    parser.add_argument(
        "--save_dir", type=str, help="root directory to save checkpoints, logs, and tensorboard"
    )
    parser.add_argument(
        "--mode",
        type=str,
...
def main():
    ...
    if args.mode == "single":
        ...
        train_cmd = (
            "python -m torch.distributed.launch --master_port %d --nproc_per_node %d lib/train/run_training.py "
