...
class LaSOTVideo(Video):
    ...
    def __init__(
        self, name, root, video_dir, init_rect, img_names, gt_rect, attr, absent, load_img=False
    ):
        super(LaSOTVideo, self).__init__(
...
class LaSOTDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        ...
        with open(os.path.join(dataset_root, name + ".json")) as f:
