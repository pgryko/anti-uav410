...
class PositionEmbeddingSine(jt.nn.Module):
    ...
    def execute(self, mask):
        ...
        dim_t = jt.arange(self.num_pos_feats, dtype=jt.float32, device=mask.device)
...
class PositionEmbeddingLearned(jt.nn.Module):
    ...
    def __init__(self, num_pos_feats=256):
        ...
        self.col_embed = jt.nn.Embedding(50, num_pos_feats)
        self.reset_parameters()

    def reset_parameters(self):
        jt.nn.init.uniform_(self.row_embed.weight)
        jt.nn.init.uniform_(self.col_embed.weight)
