...
def run_training(train_module, train_name):
    ...
    expr_module = importlib.import_module(f"ltr.train_settings.{train_module}.{train_name}")
    expr_func = expr_module.run
...
def main():
    ...
    parser.add_argument(
        "train_module", type=str, help='Name of module in the "train_settings/" folder.'
    )
